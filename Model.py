...
def get_elo():
    ...
    elo_df = elo_df[elo_df.date < '02-05-2022']
...
train = agg_games_df[agg_games_df.result.notna()]
current_week = current_week - 1
test = agg_games_df[agg_games_df.week == current_week]

msk = np.random.rand(len(train)) < 0.8


agg_games_df.to_csv('agg_data')
